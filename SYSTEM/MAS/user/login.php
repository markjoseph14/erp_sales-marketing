...
<form class="form-horizontal" role="form" action="" method="POST" style="width: 500px">
  ...
  <input type="checkbox" style="margin-left:100px" name="remember me" value="Remember me"> Remember Me<a href="forgotpassword.php" style="color:blue;margin-left:100px">Forgot Password?</a>
        <br>
        <br>
    <div class="col-sm-8">
      ...
      <a href="signup.php" style="color:blue;margin-left:150px">No account? Sign up here</a>
    </div>
      </form>
      </div>
    </div>
...
<div id="footer">
      ...
      <div class="copy">
        ...
        <div class="shell">
          <div class="carts">
          </div>  <p>&copy; Groups <a href="#"><i><font color="fefefe"> Welcome To Store Online Shopping Site </font></i></a></p>
          <div class="cl">&nbsp;</div>
