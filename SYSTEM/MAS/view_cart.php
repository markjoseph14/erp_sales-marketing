			...
			<div class="shell">
				<ul>
					...
					<li>
					  ...
					  <li><a href="signup.php">Free Sign Up</a> </li>
				</ul>
				<div class="cl">&nbsp;</div>
			</div>
			<!-- End Shell -->
...
<div class="viewcart">
	...
	if(isset($_SESSION["cart_session"]))
    {
		...
		echo '<span class="midigta"> <a  class="a-btn" href="Somstore checkout/process.php"> <span class="a-btn-text"> Pay On Store</span></a></span>';
		echo '</span>';
		echo '</form>'; 
