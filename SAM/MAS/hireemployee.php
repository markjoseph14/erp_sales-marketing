...
<div class="form-group">
    ...
    <div class="col-sm-8">
      <input class="form-control" style="color:black" name="address" type="text" placeholder="Enter your current address" required="" maxlength="30">
    </div>
  </div>
   <div class="form-group">
...
<option value="Human Resource Management">Human Resource Management</option>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      ...
      <select style="width:725px;height:35px;border-radius:5px;color:black" id="user_names" onchange="getSelectValue();">
      <option> </option>
      <?php
      $position=mysqli_query($db,"select * from position");
      while($row_pos=mysqli_fetch_array($position)){
      ?>
      <option value="<?php $row_pos['id'];?>"> <?php echo $row_pos['description']?></option>
      <?php } ?>
      </select>
      <script>
      function getSelectValue()
      { 
        var selectedValue = document.getElementByID("user_names").value;
