 ...
 <div class="clear"></div>
		...
		<div id="main" class="shell">
			...
			<br><br>
			        ...
			        <div id="kcontent">
            <h1> Store Payment Method</h1>
            <div id="wwrapper">
                <div id="steps" style="background-color:skyblue">
...
?>	
                            ...
                            <p>
                                ...
                                <input id="fullname" name="fullname" placeholder="Enter your name" AUTOCOMPLETE=OFF/>
                            </p>
                            <p>
                                <label for="email">Email:</label>
                                <input id="email" name="email" placeholder="Enter your email" type="email" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
                                <label for="country">Postal Code:</label>
                                <input id="pcode" name="pcode" type="text" placeholder="Enter your postal code" AUTOCOMPLETE=OFF />
                            </p>
...
?>
                           ...
                           <p>
                                ...
                                <input id="address" name="address" placeholder="Enter an address" type="text" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
		  ...
		  <option value="PH" countrynum="63" selected="">Philippines</option>
		  ...
		  <option value="ZW" countrynum="263">Zimbabwe</option>
                             ...
                             <p>
                                ...
                                <input id="city" name="city" placeholder="Enter a city" type="text" AUTOCOMPLETE=OFF />
                            </p>														 

							<p> 
								 <label for="Address"> Phone:</label>
                                <input id="phone" name="phone" placeholder="Enter a contact" type="tel" AUTOCOMPLETE=OFF />
                            </p>
...
?>
							...
							<p>
                                ...
                                <input id="delivery" name="delivery" placeholder="Enter the delivery address" type=" text" AUTOCOMPLETE=OFF />
                            </p>
...
if(isset($_SESSION["cart_session"]))
{
    ...
    echo ' <p> <label for="Address">Total Amount:</label> <input id="paid" class="tAmount" name="Totalka"  value=" '.$currency.$total.'"  type="text"></p>';
		...
		<!-- End Main -->
			...
			<div class="copy">
				...
				<div class="shell">
					...
					</div>	<p align="center">&copy; Store.com. Groups <a href="index.php"><i><font color="fefefe"> Welcome To <strong> Store</strong> Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
