...
if (isset($_GET['edit'])) {
  $fullname= $_GET['edit'];
  $edit_state = true;
  $rec = mysqli_query($db,"SELECT * FROM tb_sign WHERE fullname='$fullname'");
   ...
   <h2 style="text-align:center;color:blue">Registration Report</h2>
    ...
    <tbody>
       <?php while ($row = mysqli_fetch_array($results)) { ?>
          ...
          <td><a class="btn btn-success" href="regreport.php?edit=<?php echo $row['fullname']; ?>">Edit<span class="glyphicon glyphicon-edit"></span></a>
            <a class="btn btn-danger" href="regconn.php?del=<?php echo $row['fullname']; ?>">Delete<span class="glyphicon glyphicon-remove"></span></a></td>
        </tr>
        <?php } ?>
    </tbody>
...
<form class="form-horizontal" role="form" action="" method="POST" >
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <input class="form-control" style="color:black;height:35px" name="fullname" type="text" value="<?php echo $fullname; ?>">
    </div>
  </div>
  <div class="form-group">  
    <label class="col-sm-2 control-label">Contact No:</label>
    <div class="col-sm-8">
      <input class="form-control" style="color:black" name="contact" type="integer" value="<?php echo $contact; ?>">
    </div>
</div>
  <div class="form-group">  
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <input class="form-control" style="color:black;height:35px" name="address" type="text" value="<?php echo $address; ?>">
    </div>
</div>
  <div class="form-group">
    <label class="col-sm-2 control-label">Username:</label>
    <div class="col-sm-8">
      <input class="form-control" style="color:black;height:35px" name="username" type="text" value="<?php echo $username; ?>">
    </div>
</div>
  <div class="form-group">
    <label class="col-sm-2 control-label">Password:</label>
    <div class="col-sm-8">
      <input class="form-control" style="color:black;height:35px" name="password" type="password" value="<?php echo $password; ?>">
    </div>
</div>
