...
<div class="col-md-12">
  <div class="panel panel-primary">
    <div class="panel-heading" style="background-color:skyblue">
      <h1 class="panel-title" style="text-align:center">Create new account</h1>
    </div>
  ...
  <div class="form-group has-feedback" >
    ...
    <div class="col-sm-8">
      ...
      <span class="glyphicon glyphicon-lock form-control-feedback"></span>
       ...
       <div class="col-sm-8">
      <input type="submit" name="submit" class="btn btn-info" style="width:700px;margin-left:200" value="Register">
        <br>
       </div>
       </div>
      <a href="login.php" style="color:blue;margin-left:500">Already a member? Login here</a>
