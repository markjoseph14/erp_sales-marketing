...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 18, 2018 at 12:04 PM
...
(1, 'Black Tie', 44, 'clothes', 'Clothes', 7, 'Black Tie', '350.00', '33.png', 100),
(2, 'Business Casual', 44, 'clothes', 'clothes', 7, 'Business Casual', '250.00', '44.png', 100),
(3, 'Waistcoat', 44, 'clothes', 'clothes', 7, 'Waistcoat', '250.00', '55.png', 100),
(4, 'Semi Formal', 42, 'clothes', 'clothes', 8, 'Semi Formal', '300.00', '66.png', 100),
(5, 'Formal Attire', 42, 'clothes', 'clothes', 8, 'Formal Attire', '200.00', '77.png', 100),
(6, 'Casual Attire', 42, 'clothes', 'clothes', 8, 'Casual Attire', '400.00', '4.png', 100),
(7, 'Dress for kids', 42, 'clothes', 'clothes', 8, 'Dress for kids', '180.00', '2.png', 100),
(8, 'T-Shirt for kids', 42, 'clothes', 'clothes', 8, 'T-Shirt for kids', '225.00', '3.png', 100),
(9, 'Kids Suit', 42, 'clothes', 'clothes', 8, 'Kids Suit', '230.00', 't1.jpg', 100),
(10, 'Kids Suit', 42, 'clothes', 'clothes', 8, 'Kids Suit', '350.00', 't2.jpg', 100),
(11, 'Kids Suit', 42, 'clothes', 'clothes', 8, 'Kids Suit', '400.00', 't3.jpg', 100),
(12, 'Kids Suit', 42, 'clothes', 'clothes', 8, 'Kids Suit', '435.00', 't5.jpg', 100),
(13, 'Casual Wear', 42, 'clothes', 'clothes', 8, 'Casual Wear', '250.00', 't6.jpg', 100),
(14, 'Casual Wear', 42, 'clothes', 'clothes', 8, 'Casual Wear', '300.00', 't7.jpg', 100),
(15, 'Casual Wear', 42, 'clothes', 'clothes', 8, 'Casual Wear', '325.00', 't8.jpg', 100),
(16, 'Casual Wear for Kids', 42, 'clothes', 'clothes', 8, 'Casual Wear for Kids', '150.00', 't9.jpg', 100);
...
INSERT INTO `tb_sign` (`fname`, `lname`, `contact`, `email`, `address`, `username`, `password`) VALUES
('arra', 'joseph', '09979916654', 'arra@gmail.com', 'nasgbu', 'bjhg', 'kjh'),
('Mark', 'joseph', '09979916654', 'mjsalgado02@gmail.com', 'Bilaran', 'basta', 'basta');
...
--
-- Constraints for table `product_marketing`
--
ALTER TABLE `product_marketing`
  ADD CONSTRAINT `product_marketing_ibfk_1` FOREIGN KEY (`Category_ID`) REFERENCES `category` (`Category_ID`),
  ADD CONSTRAINT `product_marketing_ibfk_2` FOREIGN KEY (`Warehouse_ID`) REFERENCES `warehouse` (`Warehouse_ID`);
COMMIT;
