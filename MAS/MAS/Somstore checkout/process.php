...
?>
                           ...
                           <p>
                                ...
                                <input id="address" name="address" placeholder="Philippines" type="text" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
		  ...
		  <option value="ZW" countrynum="263">Zimbabwe</option>
							...
							<p> 
                                ...
                                <input id="phone" name="phone" placeholder="Enter an address" type="tel" AUTOCOMPLETE=OFF />
                            </p>
