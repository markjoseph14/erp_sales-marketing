...
$query=mysqli_query($db,"SELECT * FROM tb_sign where id='$id'");
...
if (isset($_POST['update'])) {
	...
	mysqli_query($db,"UPDATE tb_sign SET id='$id',fullname='$fullname',contact='$contact',email='$email',address='$address',username='$username',password='$password'");
...
if (isset($_GET['del'])) {
	$id = $_GET['del'];
	mysqli_query($db,"DELETE FROM tb_sign where id='$id'");
