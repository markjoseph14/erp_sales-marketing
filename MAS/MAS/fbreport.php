    ...
    <tbody>
       <?php while ($row = mysqli_fetch_array($results)) { ?>
          ...
          <td><a class="btn btn-success" href="fbreport.php?edit=<?php echo $row['name']; ?>">Edit<span class="glyphicon glyphicon-edit"></span></a>
              <a class="btn btn-danger" href="contactcon.php?del=<?php echo $row['name']; ?>">Delete<span class="glyphicon glyphicon-trash"></span></a></td>
        </tr>
        <?php } ?>
    </tbody>
...
<form class="form-horizontal" role="form" style="color:blue;width:900px;margin-left:50px" action="contact1.php" method="POST">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <input class="form-control" name="subject" style="color:black" type="text"  value="<?php echo $subject; ?>">
    </div>
</div>
<br>
