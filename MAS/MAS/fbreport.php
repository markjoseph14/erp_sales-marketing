...
if (isset($_GET['edit'])) {
  $id= $_GET['edit'];
  $edit_state = true;
  $rec = mysqli_query($db,"SELECT * FROM tb_contact WHERE id='$id'");
   ...
   <h2 style="text-align:center;color:blue">Feedback Report</h2>
    ...
    <tbody>
       <?php while ($row = mysqli_fetch_array($results)) { ?>
          ...
          <td><a class="btn btn-success" href="fbreport.php?edit=<?php echo $row['id']; ?>">Edit<span class="glyphicon glyphicon-edit"></span></a>
              <a class="btn btn-danger" href="contactcon.php?del=<?php echo $row['id']; ?>">Delete<span class="glyphicon glyphicon-trash"></span></a></td>
        </tr>
        <?php } ?>
    </tbody>
