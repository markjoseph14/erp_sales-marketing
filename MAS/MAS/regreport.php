...
<form class="form-horizontal" role="form" style="color:blue;width:900px;margin-left:50px" action="signup.php" method="POST">
  <div class="form-group">
    <label class="col-sm-2 control-label">ID:</label>
    <div class="col-sm-8">
      <input class="form-control" style="color:black" name="id" type="id"  value="<?php echo $id; ?>" disabled>
    </div>
  </div>
  <div class="form-group">
...
<div class="input-group">
    ...
    <?php else: ?>
    <button type="submit" name="update" class="btn btn-info" style="background-color:blue;color:white;margin-left:150px;width:500px">Update</button>
    <?php endif ?>
       </div>
</div>
</div>
