  ...
  <div class="panel panel-primary">
    <div class="panel-heading">
      <h1 class="panel-title" style="text-align:center">For any concerns, write on the feedback form</h1>
		...
		<div id="form_wrapper" class="form_wrapper" style="margin-left:300px">
				  <div class="contact-form">
					    <form method="POST" action="">
					    	<div>
						    	<span><label>ID:</label></span>
						    	<span><input type="text" style="color:black" name="id" id="id" placeholder="Enter your id here" required="" autofocus=""></span>
						    </div>
					    	<div>
						    	<span><label>NAME:</label></span>
						    	<span><input type="text" style="color:black" name="name" id="name" placeholder="Enter your name here" required=""></span>
						    </div>
						    <div>
						    		
						    	<span><label>EMAIL:</label></span>
						    	<span><input type="text" style="color:black"  name="email" id="email" placeholder="Enter your email here" required=""></span>
						    </div>
						    <div>
						     	<span><label>MOBILE NO.:</label></span>
						    	<span><input type="text" style="color:black"  name="contact" id="contact" placeholder="Enter your number here" required="" maxlength="11"></span>
						    </div>
						    <div>
						    	<span><label>SUBJECT:</label></span>
						    	<span><textarea name="subject" style="color:black"  id="textarea" placeholder="Enter the message here" required=""></textarea></span>
						    </div>
						   <div>
						   		<span><input style="width:450px" type = "submit" name="submit" id="submit" value="SUBMIT"></span>
						  </div>
					    </form>
				  </div>
