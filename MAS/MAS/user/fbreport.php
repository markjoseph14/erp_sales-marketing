...
if (isset($_GET['edit'])) {
  $name= $_GET['edit'];
  $edit_state = true;
  $rec = mysqli_query($db,"SELECT * FROM tb_contact WHERE name='$name'");
        ...
        <ul>
          ...
          <li>
            ...
            <li><a href="#">About Us</a></li>
             <li class="active"><a href="fbreport.php">Feedback Report</a></li>
   ...
   <h2 style="text-align:center;color:blue">Feedback Report</h2>
    ...
    <tbody>
       <?php while ($row = mysqli_fetch_array($results)) { ?>
          ...
          <td><a class="btn btn-success" href="fbreport.php?edit=<?php echo $row['name']; ?>">Edit<span class="glyphicon glyphicon-edit"></span></a>
            <a class="btn btn-danger" href="contactcon.php?del=<?php echo $row['name']; ?>">Delete<span class="glyphicon glyphicon-remove"></span></a></td>
        </tr>
        <?php } ?>
    </tbody>
...
<div class="container">
<div class="col-md-12" style="width:1000px;margin-left:70px">
  <div class="panel panel-primary">
    <div class="panel-heading" style="background-color:skyblue">
      <h1 class="panel-title" style="text-align:center">For any updates, edit the form</h1>
    </div>
    <div>
          <div>
              <form method="POST" action="" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input class="form-control" type="text" style="color:black" name="name" id="name" value="<?php echo $name; ?>" >
                </div>
                </div>
                <div class="form-group">    
                  <label class="col-sm-2 control-label">Email:</label>
                  <div class="col-sm-8">
                  <span><input class="form-control" type="text" style="color:black"  name="email" id="email" value="<?php echo $email; ?>">
                </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Mobile No.:</label>
                  <div class="col-sm-8">
                <input class="form-control" type="text" style="color:black"  name="contact" id="contact" value="<?php echo $contact; ?>">
                </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Subject:</label>
                  <div class="col-sm-8">
                  <span><input class="form-control" type="text" name="subject" style="color:black" id="subject" value="<?php echo $subject; ?>">
                  </div>
                </div>
    ...
    <?php else: ?>
    <button class="btn btn-info" style="width:500px;margin-left:200px" type="submit" name="update" class="btn">Update</button>
    <?php endif ?>
       </div>
</div>
              <br>
