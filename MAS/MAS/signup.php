...
<form class="form-horizontal" role="form" action="" method="POST" >
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <input class="form-control" style="color:black;height:35px" name="fullname" type="text" placeholder="Enter your fullname" required="" maxlength="30" autofocus>
    </div>
  </div>
	<div class="form-group">	
    ...
    <div class="col-sm-8">
      <input class="form-control" style="color:black;height:35px" name="password" type="password" placeholder="Enter your password" required="" maxlength="30">
       ...
       <div class="col-sm-8">
      <input class="form-control" name="submit" type="submit" style="background-color:skyblue;color:white;margin-left:300px;width:500px" value="Sign Up"><br>
       </div>
<a href="login.php" style="margin-left:500px;color:blue">Already a member? Login here</a>
